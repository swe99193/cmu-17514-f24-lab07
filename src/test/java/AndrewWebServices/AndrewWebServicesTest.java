...
public class AndrewWebServicesTest {
    ...
    public void testGetRecommendation() {
        // This is taking way too long to test
        when(andrewWebService.recommender.getRecommendation(any())).thenReturn("Animal House");
    ...
    public void testSendEmail() {
        ...
        verify(promoService, Mockito.times(1)).mailTo(anyString());
    }
    ...
    public void testNoSendEmail() {
        ...
        // Hint: is there something from Mockito that seems useful here?
        // andrewWebService.sendPromoEmail("null");
        andrewWebService.getRecommendation("null");

        verify(promoService, Mockito.times(0)).mailTo(anyString());
    }
}
